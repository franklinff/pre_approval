...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-1" id="m_login" style="background-image: url({{ asset('/metronic/theme/dist/html/default/assets/app/media/img//bg/bg-1.jpg') }}">
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__logo">
                    <a href="#">
{{--                        <img src="{{ asset('/metronic/theme/dist/html/default/assets/app/media/img//logos/logo-1.png') }}">--}}
                    </a>
                </div>
                <div class="m-login__signin">
                    ...
                    <form class="m-login__form m-form" action="{{ route('loginUser') }}" id="login">
                ...
                <div class="m-login__signup">
                    ...
                    <form class="m-login__form m-form" action="{{ route('registerUser') }}" id="register">
                        <div class="form-group m-form__group">
...
<!--end::Base Scripts -->
<!--begin::Page Snippets -->
<script src="{{ asset('/metronic/theme/dist/html/default/assets/snippets/pages/user/login.js') }}" type="text/javascript"></script>
<script>
